// Description: Java 25 JPA implementation of License history objects
...
/**
 *  CFIntJpaLicenseH provides history objects matching the CFIntLicense change history.
    ...
    implements ICFIntLicenseH, Comparable<Object>, Serializable
{
    ...
    public void setPKey( ICFIntLicenseHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFIntJpaLicenseHPKey) {
                this.pkey = (CFIntJpaLicenseHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFIntJpaLicenseHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFIntJpaLicenseH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
