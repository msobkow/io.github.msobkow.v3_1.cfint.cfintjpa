// Description: Java 25 JPA implementation of a SubProject history primary key object.
...
/**
 *	CFIntJpaSubProjectHPKey History Primary Key for SubProject
 *		requiredId	Required object attribute Id.
 */
public class CFIntJpaSubProjectHPKey
	implements ICFIntSubProjectHPKey, Comparable<Object>, Serializable
{
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFIntSubProjectHPKey rhs) {
		...
		else if (obj instanceof ICFIntSubProject rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntProtSubProjectHPKey rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFIntProtSubProject rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntPubSubProjectHPKey rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFIntPubSubProjectH rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFIntPubSubProject rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFIntJpaSubProjectHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
