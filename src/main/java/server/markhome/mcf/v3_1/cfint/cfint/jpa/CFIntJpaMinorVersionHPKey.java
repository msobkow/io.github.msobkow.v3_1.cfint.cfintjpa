// Description: Java 25 JPA implementation of a MinorVersion history primary key object.
...
/**
 *	CFIntJpaMinorVersionHPKey History Primary Key for MinorVersion
 *		requiredId	Required object attribute Id.
 */
public class CFIntJpaMinorVersionHPKey
	implements ICFIntMinorVersionHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFIntJpaMinorVersionHPKey() {
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFIntMinorVersionHPKey rhs) {
		...
		else if (obj instanceof ICFIntMinorVersionPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntMinorVersion rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntProtMinorVersionPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntPubMinorVersionPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFIntJpaMinorVersionHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
