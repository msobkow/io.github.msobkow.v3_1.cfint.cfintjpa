// Description: Java 25 JPA implementation of a MinorVersion by TenantIdx index key object.
...
public class CFIntJpaMinorVersionByTenantIdxKey
	implements ICFIntMinorVersionByTenantIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	public CFIntJpaMinorVersionByTenantIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFIntMinorVersionByTenantIdxKey, ICFIntMinorVersion$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFIntMinorVersionByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
