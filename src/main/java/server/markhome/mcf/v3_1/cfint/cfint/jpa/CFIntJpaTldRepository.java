...
public interface CFIntJpaTldRepository extends JpaRepository<CFIntJpaTld, ICFLibKeyHash256> {

	@Transactional
	@Modifying
	CFIntJpaTld save(CFIntJpaTld obj);
	...
	CFIntJpaTld get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	List<CFIntJpaTld> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	@Query("select r from CFIntJpaTld r where r.requiredId = :id")
	CFIntJpaTld lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFIntJpaTld r where r.requiredTenantId = :tenantId")
	List<CFIntJpaTld> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
