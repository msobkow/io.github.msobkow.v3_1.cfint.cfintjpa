// Description: Java 25 JPA implementation of a SubProject by TenantIdx index key object.
...
public class CFIntJpaSubProjectByTenantIdxKey
	implements ICFIntSubProjectByTenantIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFIntSubProjectByTenantIdxKey, ICFIntSubProject$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFIntSubProjectByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
