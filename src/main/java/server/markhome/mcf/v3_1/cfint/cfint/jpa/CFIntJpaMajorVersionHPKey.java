// Description: Java 25 JPA implementation of a MajorVersion history primary key object.
...
/**
 *	CFIntJpaMajorVersionHPKey History Primary Key for MajorVersion
	...
	implements ICFIntMajorVersionHPKey, Comparable<Object>, Serializable
{
	...
	public CFIntJpaMajorVersionHPKey() {
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFIntMajorVersionHPKey rhs) {
		...
		else if (obj instanceof ICFIntMajorVersionPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntMajorVersion rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntProtMajorVersionPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntPubMajorVersionPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFIntJpaMajorVersionHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
