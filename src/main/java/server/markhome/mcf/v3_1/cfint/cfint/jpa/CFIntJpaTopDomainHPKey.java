// Description: Java 25 JPA implementation of a TopDomain history primary key object.
...
/**
 *	CFIntJpaTopDomainHPKey History Primary Key for TopDomain
 *		requiredId	Required object attribute Id.
 */
public class CFIntJpaTopDomainHPKey
	implements ICFIntTopDomainHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFIntTopDomainHPKey rhs) {
		...
		else if (obj instanceof ICFIntTopDomainPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntTopDomainH rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFIntTopDomain rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntProtTopDomainPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntProtTopDomainH rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFIntProtTopDomain rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntPubTopDomainPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntPubTopDomainH rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFIntPubTopDomain rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFIntJpaTopDomainHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
