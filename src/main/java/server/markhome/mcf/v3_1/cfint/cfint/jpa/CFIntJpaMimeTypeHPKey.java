// Description: Java 25 JPA implementation of a MimeType history primary key object.
...
/**
 *	CFIntJpaMimeTypeHPKey History Primary Key for MimeType
 *		requiredMimeTypeId	Required object attribute MimeTypeId.
 */
public class CFIntJpaMimeTypeHPKey
	implements ICFIntMimeTypeHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public String toString() {
		String ret = "<CFIntJpaMimeTypeHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
