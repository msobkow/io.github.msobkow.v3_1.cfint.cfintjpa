...
/**
 *	Service for the CFIntTld entities defined in server.markhome.mcf.v3_1.cfint.cfint.jpa
...
public class CFIntJpaTldService {
	...
	public CFIntJpaTld create(CFIntJpaTld data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31TldRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFIntJpaTld)(cfint31TldRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFIntJpaTld update(CFIntJpaTld data) {
		...
		CFIntJpaTld existing = cfint31TldRepository.findById((ICFLibKeyHash256)(data.getPKey()))
	...
	public CFIntJpaTld find(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTld> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaTld lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTld> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
