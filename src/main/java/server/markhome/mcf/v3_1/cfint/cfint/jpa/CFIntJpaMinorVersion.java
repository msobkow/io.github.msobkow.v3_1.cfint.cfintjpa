// Description: Java 25 JPA implementation of a MinorVersion entity definition object.
...
public class CFIntJpaMinorVersion
		...
		Serializable
{
	...
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFInt$emitScopingMidfix$MinorVersion.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFInt$emitScopingMidfix$MinorVersion.S_INIT_UPDATED_BY);
	...
	public String toString() {
		String ret = "<CFIntJpaMinorVersion" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
