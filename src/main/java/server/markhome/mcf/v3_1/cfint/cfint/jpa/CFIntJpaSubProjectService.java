...
public class CFIntJpaSubProjectService {
	...
	public CFIntJpaSubProject create(CFIntJpaSubProject data) {
		...
		if (data.getRequiredContainerParentTPrj() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Container",
				"Container",
				"data.requiredContainerParentTPrj",
				"data.requiredContainerParentTPrj",
				"TopProject",
				"TopProject",
				null);
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31SubProjectRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFIntJpaSubProject)(cfint31SubProjectRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFIntJpaSubProject update(CFIntJpaSubProject data) {
		...
		CFIntJpaSubProject existing = cfint31SubProjectRepository.findById((ICFLibKeyHash256)(data.getPKey()))
	...
	public CFIntJpaSubProject find(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaSubProject> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaSubProject> findByTopProjectIdx(@Param("topProjectId") ICFLibKeyHash256 requiredTopProjectId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaSubProject findByNameIdx(@Param("topProjectId") ICFLibKeyHash256 requiredTopProjectId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaSubProject lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaSubProject> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaSubProject> lockByTopProjectIdx(@Param("topProjectId") ICFLibKeyHash256 requiredTopProjectId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaSubProject lockByNameIdx(@Param("topProjectId") ICFLibKeyHash256 requiredTopProjectId,
		@Param("name") String requiredName) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public void deleteByTopProjectIdx(@Param("topProjectId") ICFLibKeyHash256 requiredTopProjectId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public void deleteByNameIdx(@Param("topProjectId") ICFLibKeyHash256 requiredTopProjectId,
		@Param("name") String requiredName) {
