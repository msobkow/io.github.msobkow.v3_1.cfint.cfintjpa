...
/**
 *	Service for the CFIntTopDomain entities defined in server.markhome.mcf.v3_1.cfint.cfint.jpa
...
public class CFIntJpaTopDomainService {
	...
	public CFIntJpaTopDomain create(CFIntJpaTopDomain data) {
		...
		if (data.getRequiredContainerParentTld() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Container",
				"Container",
				"data.requiredContainerParentTld",
				"data.requiredContainerParentTld",
				"Tld",
				"Tld",
				null);
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31TopDomainRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFIntJpaTopDomain)(cfint31TopDomainRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFIntJpaTopDomain update(CFIntJpaTopDomain data) {
		...
		CFIntJpaTopDomain existing = cfint31TopDomainRepository.findById((ICFLibKeyHash256)(data.getPKey()))
	...
	public CFIntJpaTopDomain find(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopDomain> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopDomain> findByTldIdx(@Param("tldId") ICFLibKeyHash256 requiredTldId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaTopDomain findByNameIdx(@Param("tldId") ICFLibKeyHash256 requiredTldId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaTopDomain lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopDomain> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopDomain> lockByTldIdx(@Param("tldId") ICFLibKeyHash256 requiredTldId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaTopDomain lockByNameIdx(@Param("tldId") ICFLibKeyHash256 requiredTldId,
		@Param("name") String requiredName) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public void deleteByTldIdx(@Param("tldId") ICFLibKeyHash256 requiredTldId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public void deleteByNameIdx(@Param("tldId") ICFLibKeyHash256 requiredTldId,
		@Param("name") String requiredName) {
