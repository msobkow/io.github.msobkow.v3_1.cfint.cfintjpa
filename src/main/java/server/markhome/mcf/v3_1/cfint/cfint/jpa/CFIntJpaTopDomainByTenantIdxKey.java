// Description: Java 25 JPA implementation of a TopDomain by TenantIdx index key object.
...
public class CFIntJpaTopDomainByTenantIdxKey
	implements ICFIntTopDomainByTenantIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFIntTopDomainByTenantIdxKey, ICFIntTopDomain$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFIntTopDomainByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
