		...
		Serializable
{
	...
	public void setRequiredContainerParentTld(ICFIntTld argObj) {
		if(argObj == null) {
			...
			if (requiredContainerParentTld != null) {
				requiredTldId = requiredContainerParentTld.getRequiredId();
			}
			else {
			}
		}
	...
	public void setRequiredContainerParentTld(CFLibDbKeyHash256 argTldId) {
		...
		ICFIntTld targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argTldId);
