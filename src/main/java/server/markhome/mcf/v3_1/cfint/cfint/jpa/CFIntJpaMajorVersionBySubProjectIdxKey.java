// Description: Java 25 JPA implementation of a MajorVersion by SubProjectIdx index key object.
	...
	implements ICFIntMajorVersionBySubProjectIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFIntMajorVersionBySubProjectIdxKey, ICFIntMajorVersion$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFIntMajorVersionBySubProjectIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
