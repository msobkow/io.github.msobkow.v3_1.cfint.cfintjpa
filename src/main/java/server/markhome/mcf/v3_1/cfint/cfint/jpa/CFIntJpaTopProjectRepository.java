...
public interface CFIntJpaTopProjectRepository extends JpaRepository<CFIntJpaTopProject, ICFLibKeyHash256> {
	...
	CFIntJpaTopProject get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	List<CFIntJpaTopProject> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	List<CFIntJpaTopProject> findByTopDomainIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId);
	...
	CFIntJpaTopProject findByNameIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId,
	...
	@Query("select r from CFIntJpaTopProject r where r.requiredId = :id")
	CFIntJpaTopProject lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFIntJpaTopProject r where r.requiredTenantId = :tenantId")
	List<CFIntJpaTopProject> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFIntJpaTopProject r where r.requiredContainerParentSDom.requiredId = :topDomainId")
	List<CFIntJpaTopProject> lockByTopDomainIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFIntJpaTopProject r where r.requiredContainerParentSDom.requiredId = :topDomainId and r.requiredName = :name")
	CFIntJpaTopProject lockByNameIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId,
		@Param("name") String requiredName);
	...
	void deleteByTopDomainIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId);
	...
	void deleteByNameIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId,
		@Param("name") String requiredName);
