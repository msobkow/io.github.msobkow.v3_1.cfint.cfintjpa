...
/**
 *	Service for the CFIntTopProject entities defined in server.markhome.mcf.v3_1.cfint.cfint.jpa
...
public class CFIntJpaTopProjectService {
	...
	public CFIntJpaTopProject create(CFIntJpaTopProject data) {
		...
		if (data.getRequiredContainerParentSDom() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Container",
				"Container",
				"data.requiredContainerParentSDom",
				"data.requiredContainerParentSDom",
				"TopDomain",
				"TopDomain",
				null);
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfint31TopProjectRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFIntJpaTopProject)(cfint31TopProjectRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFIntJpaTopProject update(CFIntJpaTopProject data) {
		...
		CFIntJpaTopProject existing = cfint31TopProjectRepository.findById((ICFLibKeyHash256)(data.getPKey()))
	...
	public CFIntJpaTopProject find(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopProject> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopProject> findByTopDomainIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaTopProject findByNameIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaTopProject lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopProject> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public List<CFIntJpaTopProject> lockByTopDomainIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public CFIntJpaTopProject lockByNameIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId,
		@Param("name") String requiredName) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public void deleteByTopDomainIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfint31TransactionManager")
	public void deleteByNameIdx(@Param("topDomainId") ICFLibKeyHash256 requiredTopDomainId,
		@Param("name") String requiredName) {
