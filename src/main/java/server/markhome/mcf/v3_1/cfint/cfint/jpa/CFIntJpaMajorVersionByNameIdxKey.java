// Description: Java 25 JPA implementation of a MajorVersion by NameIdx index key object.
	...
	implements ICFIntMajorVersionByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFIntMajorVersionByNameIdxKey, ICFIntMajorVersion$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFIntMajorVersionByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
