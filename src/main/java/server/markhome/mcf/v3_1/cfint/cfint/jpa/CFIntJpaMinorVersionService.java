...
/**
 *	Service for the CFIntMinorVersion entities defined in server.markhome.mcf.v3_1.cfint.cfint.jpa
...
public class CFIntJpaMinorVersionService {
	...
	public CFIntJpaMinorVersion create(CFIntJpaMinorVersion data) {
		...
		boolean generatedRequiredId = false;
			...
			if (data.getRequiredContainerParentMajVer() == null) {
				throw new CFLibNullArgumentException(getClass(),
					S_ProcName,
					0,
					"data.getRequiredContainerParentMajVer()");
			}
