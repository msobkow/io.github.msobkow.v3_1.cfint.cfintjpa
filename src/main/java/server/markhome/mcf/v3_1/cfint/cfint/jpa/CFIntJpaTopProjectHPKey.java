// Description: Java 25 JPA implementation of a TopProject history primary key object.
...
/**
 *	CFIntJpaTopProjectHPKey History Primary Key for TopProject
 *		requiredId	Required object attribute Id.
 */
public class CFIntJpaTopProjectHPKey
	implements ICFIntTopProjectHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFIntJpaTopProjectHPKey() {
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFIntTopProjectPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntProtTopProjectPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFIntPubTopProjectPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFIntJpaTopProjectHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
