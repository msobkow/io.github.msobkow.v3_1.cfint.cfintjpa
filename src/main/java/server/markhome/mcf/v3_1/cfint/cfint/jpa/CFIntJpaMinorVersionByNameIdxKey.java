// Description: Java 25 JPA implementation of a MinorVersion by NameIdx index key object.
	...
	implements ICFIntMinorVersionByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFIntMinorVersionByNameIdxKey, ICFIntMinorVersion$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFIntMinorVersionByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
