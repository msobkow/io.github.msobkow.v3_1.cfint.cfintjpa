// Description: Java 25 JPA implementation of a Tld by TenantIdx index key object.
...
public class CFIntJpaTldByTenantIdxKey
	implements ICFIntTldByTenantIdxKey, Comparable<Object>, Serializable
{
	protected ICFLibKeyHash256 requiredTenantId;
	public CFIntJpaTldByTenantIdxKey() {
	...
	public String toString() {
		String ret = "<CFIntTldByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
